...
def test_serialize_checkpoint_outputs_skips_unserializable() -> None:
    ...
    original = runner_mod.serialize_value
    ...
    with patch.object(runner_mod, "serialize_value", side_effect=_raising_serialize):
        result = _serialize_checkpoint_outputs(outputs)
...
async def test_save_checkpoint_payload_structure() -> None:
    ...
    try:
        ...
        runner_module.SessionLocal = lambda: mock_session  # type: ignore[assignment]
        ...
        runner_module.SessionLocal = original_exec
...
async def test_checkpoint_truncates_oversized_payload() -> None:
    ...
    original_execute = runner_module.SessionLocal
    try:
        runner_module.SessionLocal = lambda: mock_session  # type: ignore[assignment]
        ...
        runner_module.SessionLocal = original_execute
