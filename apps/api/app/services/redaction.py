...
# ``invalidate_secret_cache()`` to drop the cache. For multi-replica
# deployments the cache is per-process — a shared invalidation signal would
# be needed there, which is out of scope until Slice 8.
