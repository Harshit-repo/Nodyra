...
def upgrade() -> None:
    ...
    if bind.dialect.name == "postgresql":
        ...
        # to_timestamp() interprets the float as Unix epoch seconds.
        # SQLite is dynamically typed — the column stores whatever Python gives it.
        ...
        # SQLite ignores VARCHAR width constraints, so this is a no-op there.
        bind.execute(sa.text(
