...
export function NodyraEdge({
  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        <div
          className={`nodyra-edge-mid nodrag nopan${selected ? " is-selected" : ""}`}
          style={{
            position: "absolute",
        ...
        >
          {label && <span className="nodyra-edge-label">{String(label)}</span>}
          {edgeType.icon && (
            <div className="nodyra-edge-type-badge" title={edgeType.label}>
          ...
          <div className="nodyra-edge-actions">
            <button
              type="button"
              className="nodyra-edge-btn nodyra-edge-btn-add"
              title="Insert node into connection"
              onClick={(event) => {
                event.stopPropagation();
                window.dispatchEvent(new CustomEvent("nodyra:open-edge-quick-add", {
            ...
            <button
              type="button"
              className="nodyra-edge-btn nodyra-edge-btn-delete"
