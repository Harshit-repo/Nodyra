...
given hash builds a uv venv under ``~/.noodle-runner/envs/{env_id}-{hash}``
and installs ``noodle-runtime noodle-nodes noodle-core`` plus the env's
...
from noodle_runner_agent.config import data_dir
