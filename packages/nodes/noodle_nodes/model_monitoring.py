"""Model monitoring, observability, and lifecycle management nodes for Noodle."""
...
def _is_registry_ref(val: Any) -> bool:
    return isinstance(val, dict) and val.get("__noodle_model_registry__") is True
...
def model_promote(
    ...
    if require_eval_result:
        has_eval = (
            entry.get("__noodle_eval_result__") is True
    ...
    promoted_entry = {
        **entry,
        "__noodle_model_registry__": True,
