...
from noodle_nodes.integrations_v2.providers.twilio.operations import _credentials_dict
    ...
    *,
    ...
    if connect_fn is None:
        raise RuntimeError(
            ...
            "This node must run inside a Noodle runtime that supports node WebSockets."
        )
