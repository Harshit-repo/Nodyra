...
from nodyra_nodes.ai_v2.prompt_safety import (
    UNTRUSTED_TOOL_OUTPUT_CLOSE as _UNTRUSTED_TOOL_OUTPUT_CLOSE,
)
from nodyra_nodes.ai_v2.prompt_safety import (
    UNTRUSTED_TOOL_OUTPUT_NOTICE as _UNTRUSTED_TOOL_OUTPUT_NOTICE,
)
from nodyra_nodes.ai_v2.prompt_safety import (
    UNTRUSTED_TOOL_OUTPUT_OPEN as _UNTRUSTED_TOOL_OUTPUT_OPEN,
)
from nodyra_nodes.ai_v2.prompt_safety import (
    unwrap_untrusted_tool_output as _unwrap_untrusted_tool_output,
)
from nodyra_nodes.ai_v2.prompt_safety import (
    wrap_untrusted_tool_output as _wrap_untrusted_tool_output,
)
from nodyra_nodes.ai_v2.tools import collect_tool_adapters

AI_CATEGORY = "AI"
TOOL_SYSTEM_PREFIX = "Nodyra tools available in this run:"
PLAN_PREFIX = "__nodyra_plan__"
USAGE_PREFIX = "__nodyra_usage__"
COMPRESSED_PREFIX = "__nodyra_compressed__"
UNTRUSTED_TOOL_OUTPUT_NOTICE = _UNTRUSTED_TOOL_OUTPUT_NOTICE
UNTRUSTED_TOOL_OUTPUT_OPEN = _UNTRUSTED_TOOL_OUTPUT_OPEN
UNTRUSTED_TOOL_OUTPUT_CLOSE = _UNTRUSTED_TOOL_OUTPUT_CLOSE
...
def _load_usage(messages: list[AIMessage]) -> ModelUsage:
    """Parse the accumulated usage from a ``__nodyra_usage__`` control message."""
...
def _inject_plan(messages: list[AIMessage], plan: list[str]) -> list[AIMessage]:
    ...
    Prepends a ``__nodyra_plan__`` system marker (stripped before outbound
