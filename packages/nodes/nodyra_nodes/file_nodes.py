...
from nodyra_nodes.datasets import csv_parse as csv_parse  # re-exported for patching
...
def _parse_file_bytes(
    ...
    *,
    ...
    if fmt == "parquet":
        ...
        from nodyra.datasets import reserve_artifact_path
        from nodyra_nodes.datasets import _finalize_parquet
...
def stream_large_file(
    ...
    from nodyra.context import emit_chunk
    from nodyra.datasets import reserve_artifact_path
    from nodyra_nodes.datasets import _finalize_parquet
...
def write_parquet_file(
    ...
    *,
    ...
    if isinstance(input, dict) and input.get("__nodyra_dataset__"):
