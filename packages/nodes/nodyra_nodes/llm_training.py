...
from nodyra.artifacts import is_artifact_ref, read_bytes, write_bytes
...
_FT_DATASET_MARKER = "__nodyra_finetune_dataset__"
_FT_JOB_MARKER = "__nodyra_finetune_job__"
_MODEL_ARTIFACT_MARKER = "__nodyra_model_artifact__"
_MODEL_REGISTRY_MARKER = "__nodyra_model_registry__"
...
@node(
    ...
    icon="bookmarks",
    description=(
        "Register a fine-tuned model in Nodyra's workflow-local model registry. "
