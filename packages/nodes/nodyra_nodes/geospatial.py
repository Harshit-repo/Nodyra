...
from nodyra.artifacts import is_artifact_ref, read_bytes, write_text
...
def geocode(
    ...
    user_agent: str = "nodyra-geocoder",
    ...
    geocoder = Nominatim(user_agent=user_agent or "nodyra-geocoder")
    rows = _to_records(input)
