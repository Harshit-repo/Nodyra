"""Statistical analysis and data science nodes for Nodyra.

All scientific packages (scipy, statsmodels, numpy, pulp, scikit-learn) are
lazy-imported inside each function body. nodyra_nodes.datasets helpers are
imported at module scope — they are Nodyra core, always present.
"""
...
def monte_carlo_simulate(
    ...
    from nodyra.expr import _SAFE_BUILTINS, _ExprValidator
...
def optimization_solve(
    ...
    prob = _pulp.LpProblem("nodyra_opt", sense_val)
