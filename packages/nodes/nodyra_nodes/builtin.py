...
@node(
    ...
    params={
        ...
        "require_login": {
            ...
            "group": "Options",
            "default": True,
            "description": "Require visitors to sign into this Nodyra instance.",
        },
        "chat_token": {
            "type": "string",
            "widget": "hidden",
...
def loop_over_items(input: Any = None, max_items: int = 0) -> dict:
    ...
    Nodyra's current DAG engine executes a node once per run rather than once
...
# Import the shared blocked-modules set from nodyra.expr (where _CodeValidator
...
from nodyra.expr import CODE_NODE_BLOCKED_MODULES as _CODE_NODE_BLOCKED_IMPORTS  # noqa: E402
...
async def execute_workflow_node(input: Any = None, workflow_id: str = "") -> Any:
    """Run another Nodyra workflow as a step and return its result."""
...
async def map_items(
    ...
    from nodyra.context import workflow_caller
    from nodyra_nodes._map import _map_call_child
