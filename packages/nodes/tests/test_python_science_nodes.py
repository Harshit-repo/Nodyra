...
_PATCH_CHART_WB = patch("noodle_nodes.python_science_nodes.write_bytes", return_value=_FAKE_CHART)
...
_PATCH_WB = patch("noodle_nodes.python_science_nodes.write_bytes", return_value=_FAKE_ARTIFACT)
